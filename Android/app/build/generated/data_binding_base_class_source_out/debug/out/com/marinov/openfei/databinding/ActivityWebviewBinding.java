...
public final class ActivityWebviewBinding implements ViewBinding {
  ...
  private ActivityWebviewBinding(@NonNull CoordinatorLayout rootView, @NonNull WebView webview) {
  ...
  public static ActivityWebviewBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityWebviewBinding((CoordinatorLayout) rootView, webview);
    }
