...
public final class ItemProfileBinding implements ViewBinding {
  ...
  private ItemProfileBinding(@NonNull LinearLayout rootView, @NonNull TextView itemLabel,
      @NonNull TextView itemValue) {
  ...
  public static ItemProfileBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemProfileBinding((LinearLayout) rootView, itemLabel, itemValue);
    }
