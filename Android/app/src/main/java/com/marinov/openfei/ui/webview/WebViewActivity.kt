...
class WebViewActivity : AppCompatActivity() {
    ...
    private fun setupWebView() {
        ...
        webChromeClient = object : WebChromeClient() {
            override fun onShowFileChooser(
                ...
                try {
                    ...
                    Toast.makeText(this@WebViewActivity, getString(R.string.nenhum_app_para_arquivos), Toast.LENGTH_LONG).show()
                    return false
                }
                return true
            }
        ...
        webView.setDownloadListener { url, userAgent, contentDisposition, mimetype, _ ->
            try {
                ...
                Toast.makeText(applicationContext, getString(R.string.erro_ao_iniciar_download), Toast.LENGTH_SHORT).show()
            }
        }
    }
    ...
    private fun handleUrlOverride(url: String?, context: Context?): Boolean {
        ...
        try {
            ...
            Toast.makeText(context, getString(R.string.nenhum_navegador_encontrado), Toast.LENGTH_SHORT).show()        }
        return true
    }
