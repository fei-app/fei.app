...
class LoginWindow(Gtk.Box):
    def __init__(self, app, run_async_callback, on_login_success):
        ...
        # Alterado de "Login OpenFEI" para "OpenFEI"
        title = Gtk.Label(label="OpenFEI")
        ...
        # Ao apertar 'Enter' no campo de senha, ele submete o login
        self.pass_entry.connect('activate', self.on_login_clicked)
    ...
    # Note que agora recebemos widget genérico (pode ser Entry ou Button)
    ...
    def set_loading(self, loading: bool):
        ...
        self.pass_entry.set_sensitive(not loading)
        self.user_entry.set_sensitive(not loading)
